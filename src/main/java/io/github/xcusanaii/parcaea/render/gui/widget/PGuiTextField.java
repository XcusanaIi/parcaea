...
public class PGuiTextField extends Gui {
    ...
    public PGuiTextField(int componentId, FontRenderer fontRendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, ColorGeneral.BUTTON_COLOR);
                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, ColorGeneral.BUTTON_COLOR_HOVER);
            }
